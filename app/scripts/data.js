  ...
  PanlinCap.reqres.setHandler('cases:fetch', function() {
    ...
    var cases = [{
      ...
      brands : [{
        ...
        descriptions : '宫颈癌生物基因检测领域的市场领导者。宫颈癌是仅次于乳腺癌的第二大妇科肿瘤，国家对其检测预防的扶持力度不断加大，中国各地已陆续开展筛查宫颈癌的高危型人乳头瘤病毒分型检测；公司是中国宫颈癌防治工程的战略合作伙伴，并与国家疾病预防控制中心及中国宫颈癌防治工程进行全国性的深度合作；公司产品拥有10项中美专利，已在全国超过数百家医院建立了可高效扩张的销售和服务平台，未来高速成长可期。公司荣获“2012中国医疗健康产业最具投资价值企业TOP10”殊荣。'
      }, {
        title : '康泰生物',
        website : 'http://www.biokangtai.com/docc',
        brand : '/images/cases/康泰生物.png',
        descriptions : '国内疫苗行业的龙头公司。基于公司全资子公司北京民海生物科技有限公司（http://www.biominhai.com）强大的研发平台，公司20余年的行业经验和工艺生产及质量检测水平，随着国内首创的无细胞百白破b型流感嗜血杆菌联合疫苗、成人60微克乙肝疫苗、肺炎疫苗、人二倍体狂犬疫苗等系列化新产品的上市，公司具有爆发性的成长空间和增长潜力。'
      }, {
        title : '德易东方',
        website : 'http://www.deyidongfang.com',
        brand : '/images/cases/德易东方.png',
        descriptions : '公司为国内最贴近临床应用的基因测序服务公司，已将多种实验室高端医学诊断技术转化为临床应用项目，利用基因二代测序技术，可一次性检测分析4000多种遗传病，准确地协助医生进行临床诊断，已与国内多家著名医院开展业务合作；其国内首创的疾病基因组数据库正不断扩充和完善。'
      }, {
        title : '赛安生物',
        website : 'http://www.shineschina.com',
        brand : '/images/cases/赛安生物.png',
        descriptions : '公司为国内践行个体化治疗与精准医疗的先行者之一，利用多样化的检测技术平台提供从肿瘤早期筛查、个体化用药筛选、疗效判定、愈后复发、放疗靶标、生物免疫治疗等覆盖整个过程的解决方案，在产品开发和市场建设方面都有基础，并以共建中心模式协助各大医院建立完善的肿瘤分子医学诊断中心。公司在肿瘤分子诊断领域，是提供最多检测平台、检测指标的单位之一，获得Frost&Sullivan公司颁发的中国体外诊断行业的2014年度最佳实践奖。  '
      }, {
        title : '爱德牛业',
        website : 'http://www.indlifetech.com.cn',
        brand : '/images/cases/爱德牛业.png',
        descriptions : '高产奶牛生物胚胎移植领域的龙头公司。随着中国居民可支配收入的快速增加，国内牛奶消费进入快速增长阶段，引入高产加系荷斯坦奶牛对提升国内奶牛单产具有极大的意义；公司是世界上最大的以胚胎移植的方法进行奶牛和肉牛繁育改良中心，也是目前在中国奶牛繁育市场唯一一家能够进行高品质胚胎技术产品产供销一条龙服务的企业；公司采用现代生物育种技术，可快速改良和替代我国大部分低产奶牛；通过独特的小区托管模式快速扩张产能，获得爆发式增长机会；公司获得清科“2010年中国最具投资价值企业50强”称号。'
      }]
    }, {
      title : '新的消费模式',
      brands : [{
        ...
        descriptions : '公司专注于网页游戏、社交游戏以及移动互联网游戏等跨平台市场，拥有熟练掌握Flash、Unity3D以及Html5等多种网页游戏核心开发技术并具备丰富运营经验的优秀团队，是国内以自主研发为核心并兼具游戏运营竞争力的一线企业。目前公司拥有超过5000万的高粘度、高付费偏向的自有注册用户资源，在动漫题材的游戏用户市场雄踞第一。公司未来的战略目标是通过强IP战略的实施，不断向市场推出重量级的游戏产品，成为网络游戏行业的领导企业。'
      }, {
        title : '盛世骄阳',
        website : 'http://www.sun-tv.com.cn',
        brand : '/images/cases/盛世骄阳.png',
        descriptions : '公司是国内领先的新媒体影视节目整合、发行和运营公司,是专门面向视听新媒体市场的数字版权节目集成交易服务商，是目前国内唯一覆盖所有数字媒体渠道的版权发行商。公司拥有目前国内规模最大的精品长销剧独家数字版权节目库，其B2B发行覆盖90%主流网络视频网站以及50%的数字电视发行渠道。'
      }, {
        title : '创新科技',
      ...
      brands : [{
        ...
        descriptions : '公司专注于氨氮废水处理领域，是目前国内中高浓度氨氮废水处理行业经营规模最大的公司之一。其所处的细分市场是万亿环保大产业中增长最快的（废）污水氨氮处理领域。作为国内较早涉足中高浓度氨氮废水处理的环保企业，公司积累了丰富的项目经验，尤其在有色、稀土、化工等行业内具有较高的美誉度。公司已具备目前国内最完善和涵盖面最广的氨氮废水处理技术体系。'
      }]
    }];
