  ...
  PanlinCap.reqres.setHandler('members:fetch', function() {
    ...
    var data = [{
      ...
      descriptions : [
        ...
        '<p>作为磐霖资本的创始合伙人，李宇辉先生长期从事国内资本市场的投资，在私募股权投资领域具有独到的投资理念和系列化的成功案例，专注投资于新的消费模式、医疗健康和节能环保产业，作为项目负责人，先后主持投资了探路者（户外运动产品，300005，A轮主投）、东方时尚（连锁驾驶培训，A轮主投）、盛世骄阳（电视数字版权，已被皇氏集团（002329）吸收合并）、高能环境（固废土壤修复，603588，A轮主投）、华夏滤园（植物生态修复，天使轮主投）、康泰生物（人用二类疫苗，B轮主投）、凯普生物（体外诊断试剂）、赛安生物（肿瘤分子诊断，A轮主投）、瑞博生物（小核酸药物）等PE/VC项目，并主持磐霖东方基金、磐霖平安基金在4年内分别取得超过8倍和5倍的优秀投资业绩。</p>',
      ...
      descriptions : [
        ...
        '<p>王利波先生从事私募股权投资行业以来，专注于投资医疗健康和现代农业产业，先后主持投资了爱德牛业（生物胚胎）、创新生物（无抗生物饲料，A轮主投）等PE项目，参与了高能环境（固废土壤修复，603588，A轮主投）、东方时尚（连锁驾驶培训，A轮主投）、康泰生物（人用二类疫苗，B轮主投）、盛世骄阳（电视数字版权，已被皇氏集团（002329）吸收合并）、德易东方（基因测序，A轮主投）等项目，并担任盛世骄阳的监事、德易东方的监事及康泰生物的董事会观察员。</p>',
      ...
      descriptions : [
        ...
        '<p>作为磐霖资本的合伙人，谭惠东先生长期从事国内资本市场的投资，熟悉金融市场和企业运营，擅长行业分析，尤其对节能环保及医疗健康领域的企业价值和公司治理有深入研究和理解，在成就企业价值过程中发挥较大作用。先后参与投资了佳宇资源（资源综合回收利用）、高能环境（固废土壤修复，603588，A轮主投）、康泰生物（人用二类疫苗，B轮主投）、凯普生物（体外诊断试剂）、华夏滤园（植物生态修复，天使轮主投）等PE项目，获得了良好的投资业绩。谭惠东先生同时还担任广东凯普生物科技股份有限公司董事会观察员、江苏佳宇资源利用股份有限公司执行管理委员会委员、无锡华夏滤园环保科技有限公司监事。</p>',
      ...
      descriptions : [
        ...
        '<p>薛孟军先生在环保、消费、TMT领域从事了多年的股权投资工作，在上述领域成功完成多个项目投资，在企业价值判断、尽职调查、投后管理、项目退出、后续融资、财务管理与规范等方面积累了丰富的实战经验，能够帮助被投企业实现快速的价值提升。在磐霖资本， 薛孟军先生先后主持了骏梦游戏（网络游戏，已被富春通信（300299）吸收合并）、华夏滤园（植物生态修复，天使轮主投）、盛诺基（肿瘤创新药，D轮主投）等项目，参与了东方时尚（连锁驾驶培训，A轮主投）、康泰生物（人用二类疫苗，B轮主投）等投资项目，现任无锡华夏滤园环保科技有限公司董事。</p>', 
      ].join('')
    }, {
      id : 5,
      name : '唐爱民',
      ...
      descriptions : [
        ...
        '<p>唐爱民先生有丰富的医疗健康行业PE&VC投资经验，先后主持了康泰生物（人用二类疫苗）、新旭发科技（医药设备）的投资，并参与了新产业生物（化学免疫发光）、美诺华药业（原料药）的投资；在磐霖资本，主持了德易东方（基因测序）的A轮主投，参与了赛安生物（肿瘤分子诊断）、盛诺基（肿瘤创新药）、瑞博生物（小核酸药物）的投资，所投资企业均有优异的业绩增长表现。 </p>',
      ...
      descriptions : [
        ...
        '<p>缪波先生专注于医疗健康和节能环保领域的深度挖掘，已先后参与德易东方（基因测序）、康泰生物（人用二类疫苗）、华杉环保（废水处理）、华夏滤园（植物生态修复）等多个PE/VC项目的投资和投后管理。</p>',
      ...
      descriptions : [
        ...
        '<p>孙颖先生专注于医疗健康领域的投资和资源整合。加入磐霖资本前，曾任职上海盛宇股权投资基金管理有限公司投资经理，善于挖掘和筛选一二级投资市场医疗领域项目，尤其是在IVD行业和生物制药行业拥有专业的判断力和分析能力。在磐霖资本，先后参与了盛诺基（肿瘤创新药）、瑞博生物（小核酸药物）项目投资。</p>'
      ].join('')
    }, {
      id : 11,
      name : '王超',
      ...
      descriptions : [
        ...
        '<p>加入磐霖资本前，曾任职上海集博投资管理咨询有限公司（GBI Health）助理总监、产品经理，及北京东胜创新生物技术有限公司销售代表，经历多年移动医疗产品开发、医疗健康行业咨询、行业情报决策产品（SOURCE）开发，服务客户包括20余家在华大中型跨国药企如Sanofi、Eli Lily、Roche、Bayer Tech等，业务后期并拓展至拉美、巴西等地区，对医疗医药行业有较深的认知。在磐霖资本，已先后参与德易东方（基因测序）、赛安生物（肿瘤分子诊断）等多个PE/VC项目的投资和投后管理。</p>'
      ].join('')
    }, {
      id : 12, 
      name : '张寅',
      ...
      descriptions : [
        ...
        '<p>在磐霖资本，参与了赛安生物（肿瘤分子诊断）、盛诺基（肿瘤创新药）的投资，并担任瑞博生物（小核酸药物）项目投资的现场管理。</p>'
      ].join('')
    }, {
      id : 13,
      name : '李新成',
      ...
      descriptions : [
        ...
        '<p>李新成先生曾在鲁证期货股份有限公司从事商品期货的投资研究，并多次参与地方金融中心建设、金融产业园区规划，具备较强的宏观经济及行业分析能力。在磐霖资本，已先后参与了赛安生物（肿瘤分子诊断）、瑞博生物（小核酸药物）等多个PE/VC项目的投资。</p>'
      ].join('')
