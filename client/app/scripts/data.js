  ...
  PanlinCap.reqres.setHandler('members:fetch', function() {
    ...
    var data = [{
      ...
      descriptions : [
        ...
        '<p>作为磐霖资本的创始合伙人，李宇辉先生长期从事国内资本市场的投资，在私募股权投资领域具有独到的投资理念和系列化的成功案例，专注投资于消费升级、医疗健康和节能环保产业，先后主持投资了探路者、东方时尚、高能环境、康泰生物、凯普生物、盛世骄阳、华夏滤园、赛安生物、瑞翔新材等PE项目，取得优秀的投资业绩。</p>',
        ...
        '<p>基于多年的投行经历，李宇辉先生拥有广泛的项目来源、专业判断和项目争取、谈判和后续管理能力，善于整合业务资源及协调所有项目参与方的关系，在投资成为公司股东后能有效推动公司规范化运作和主导公司上市及并购事宜。现任华夏滤园董事、赛安生物董事、瑞翔新材董事、东方时尚监事。</p>'
      ].join('')
    }, {
      id : 2,
      name : '王利波',
      ...
      descriptions : [
        ...
        '<p>作为磐霖资本的合伙人，谭惠东先生长期从事国内资本市场的投资，熟悉金融市场和企业运营，擅长行业分析，尤其对节能环保及医疗健康领域的企业价值和公司治理有深入研究和理解，在成就企业价值过程中发挥较大作用。先后投资了佳宇资源、高能环境、康泰生物、凯普生物等PE项目，获得了良好的投资业绩。谭惠东先生同时还担任凯普生物董事会观察员、江苏佳宇执行管理委员会委员。</p>',
